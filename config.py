...
OWNER_ID = int(getenv("OWNER_ID", 6533238636))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Masoom_FeeIings")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Friends_Squads")
